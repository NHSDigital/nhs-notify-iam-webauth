module "amplify_branch" {
  ...
  environment_variables = {
    ...
    NEXT_PUBLIC_COGNITO_DOMAIN      = "https://${local.use_custom_cognito_domain ? aws_cognito_user_pool_domain.custom[0].domain : aws_cognito_user_pool_domain.main.domain}"
