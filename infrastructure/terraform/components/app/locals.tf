locals {
  ...
  auth_gateway_name = var.cognito_user_pool_use_environment_specific_gateway_callback_url ? "https://${var.environment}.${var.cognito_user_pool_environment_specific_gateway_callback_url_suffix}" : "${aws_amplify_app.main.default_domain}/auth"
  cis2_issuer_urls = {
